...
The MinIO bucket is **not** in this list — `pnpm setup` runs the `minio-init` container to create it automatically. Older runbooks that say "create the bucket via the MinIO console" are stale.
