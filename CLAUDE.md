...
- MinIO must be running (`pnpm infra:up` starts all services including MinIO) before using storage locally. Create the default bucket via the MinIO console at `http://localhost:9001` (login: tailorweddings2 / tailorweddings2123).
